...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href="/sbadmin2/bower_components/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">

    <!-- MetisMenu CSS -->
    <link href="/sbadmin2/bower_components/metisMenu/dist/metisMenu.min.css" rel="stylesheet">

    <!-- Timeline CSS -->
    <link href="/sbadmin2/dist/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="/sbadmin2/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="/sbadmin2/bower_components/morrisjs/morris.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="/sbadmin2/bower_components/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">

    <!-- Dashboard css -->
    <link href="/laravel16/css/dashboard.css" rel="stylesheet" type="text/css">
...
<script src="/sbadmin2/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
