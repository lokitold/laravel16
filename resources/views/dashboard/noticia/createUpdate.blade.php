...
@section('content')
        ...
        <div class="col-md-11">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    {!! Form::label('locacioness', 'Localizaciones de la nota') !!}
                    ...
                    <div class="form-group">
                        {!! Form::submit('Agregate location', ["class" => "btn btn-success "]) !!}
                    </div>
    ...
    <script async defer
            src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA2g6-YR2236S6r66mOjlNYE-eoiVvETvw&signed_in=true&libraries=places&callback=initAutocomplete"></script>
@endsection
